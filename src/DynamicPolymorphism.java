...
public class DynamicPolymorphism {
    ...
    //we can declare an obj and make space for that in memory but not sure which type of obj we want. we want animal but dont no which kind so we make space for it
